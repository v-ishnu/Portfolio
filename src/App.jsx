...
function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-gray-200 select-none font-outfit">
      <div className="h-[105vh] flex flex-col bg-white rounded-bl-[70px] rounded-br-[70px] md:rounded-bl-[105px] md:rounded-br-[105px] lg:rounded-bl-[105px] lg:rounded-br-[105px] border border-gray-300">
        <div className="h-[80vh] bg-gray-200 border border-gray-300 rounded-bl-[70px] rounded-br-[70px] md:rounded-bl-[105px] md:rounded-br-[105px] lg:rounded-bl-[105px] lg:rounded-br-[105px]">
          ...
          <div className="hidden md:flex lg:flex flex-row h-[15%] items-center justify-between px-11">
            <div className="flex flex-row h-10 w-max border border-gray-300 text-black items-center pl-4 pr-[2px] rounded-full">
      ...
      <div className="flex flex-col relative justify-center items-center h-full w-full py-24 gap-[60px]">
        ...
        <div className="relative flex w-full h-[1px] bg-gray-300 justify-center items-center">
          <div className="absolute justify-center px-7 py-4 bg-white z-10 rounded-full -rotate-[20deg]">
